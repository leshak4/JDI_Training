...
import com.epam.jdi.uitests.testing.appln.page_objects.enums.Locations;
import com.epam.jdi.uitests.testing.appln.page_objects.entities.JobSearchFilter;
...
public class JobFilter extends Form<JobSearchFilter> {
    ...
    @FindBy(className = "appln-location-box")
